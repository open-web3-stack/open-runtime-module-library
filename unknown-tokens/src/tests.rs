...
fn deposit_concrete_fungible_asset_works() {
	ExtBuilder.build().execute_with(|| {
		...
		System::assert_has_event(Event::unknown_tokens(crate::Event::Deposited(asset, MOCK_RECIPIENT)));
...
fn withdraw_concrete_fungible_asset_works() {
	ExtBuilder.build().execute_with(|| {
		...
		System::assert_has_event(Event::unknown_tokens(crate::Event::Withdrawn(asset.clone(), MOCK_RECIPIENT)));
