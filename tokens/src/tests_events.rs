...
use frame_support::{
	assert_ok,
	traits::{
		tokens::Restriction, Currency as PalletCurrency, LockableCurrency as PalletLockableCurrency,
...
#[test]
fn test_fungible_events() {
	ExtBuilder::default()
		.balances(vec![(ALICE, DOT, 100), (BOB, DOT, 100)])
		.build()
		.execute_with(|| {
			assert_eq!(<MockCurrencyAdapter as fungible::Mutate<_>>::shelve(&ALICE, 30), Ok(30));
			assert_eq!(System::events(), vec![]);

			assert_eq!(<Tokens as fungibles::Mutate<_>>::shelve(DOT, &BOB, 30), Ok(30));
			//assert_eq!(System::events(), vec![]);
		});
}
...
// 		.build()
// 		.execute_with(|| {
// 			assert_ok!(<Tokens as MultiCurrency<AccountId>>::transfer(DOT, &ALICE, &BOB,
// 10)); 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::Transfer {
// 				currency_id: DOT,
// 				from: ALICE,
// 				to: BOB,
// 				amount: 10,
...
// 			assert_ok!(<Tokens as MultiReservableCurrency<AccountId>>::reserve(DOT,
// &ALICE, 50)); 			assert_eq!(<Tokens as MultiCurrency<AccountId>>::slash(DOT,
// &ALICE, 60), 20);
...
// 			assert_eq!(
// 				<Tokens as MultiReservableCurrency<AccountId>>::slash_reserved(DOT, &ALICE,
// 300), 				0
// 			);
// 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::Slashed {
// 				currency_id: DOT,
...
// 			assert_ok!(<Tokens as
// MultiReservableCurrency<AccountId>>::repatriate_reserved( 				DOT,
// 				&ALICE,
// 				&BOB,
// 				100,
// 				BalanceStatus::Free
...
// 		.build()
// 		.execute_with(|| {
// 			assert_ok!(<Tokens as fungibles::Mutate<AccountId>>::mint_into(DOT, &ALICE,
// 500)); 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::Deposited
// { 				currency_id: DOT,
// 				who: ALICE,
// 				amount: 500,
// 			}));
...
// 		.execute_with(|| {
// 			assert_ok!(<Tokens as MultiReservableCurrency<AccountId>>::reserve(DOT,
// &ALICE, 50)); 			assert_ok!(<Tokens as
// fungibles::Unbalanced<AccountId>>::write_balance( 				DOT, &ALICE, 500
// 			));
...
// 			// System::reset_events();
// 			// assert_eq!(
// 			// 	<Tokens as fungibles::MutateHold<AccountId>>::release(DOT, REASON, &BOB,
// 50, Precision::Exact), 			// 	Ok(50)
// 			// );
// 			// System::assert_last_event(RuntimeEvent::Tokens(crate::Event::Unreserved {
// 			// 	currency_id: DOT,
// 			// 	who: BOB,
...
// 			std::mem::forget(<MockCurrencyAdapter as
// PalletCurrency<AccountId>>::burn(500));
// 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::TotalIssuanceSet
// { 				currency_id: DOT,
// 				amount: 0,
// 			}));
...
// 			std::mem::forget(<MockCurrencyAdapter as
// PalletCurrency<AccountId>>::issue(200));
// 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::TotalIssuanceSet
// { 				currency_id: DOT,
// 				amount: 200,
// 			}));
...
// 			assert_ok!(<Tokens as MultiReservableCurrency<AccountId>>::reserve(DOT, &BOB,
// 50)); 			std::mem::forget(<MockCurrencyAdapter as
// PalletCurrency<AccountId>>::slash(&BOB, 100));
// 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::Slashed {
// 				currency_id: DOT,
// 				who: BOB,
// 				free_amount: 100,
...
// 			std::mem::forget(<MockCurrencyAdapter as
// PalletCurrency<AccountId>>::make_free_balance_be(&BOB, 200));
// 			System::assert_last_event(RuntimeEvent::Tokens(crate::Event::BalanceSet {
// 				currency_id: DOT,
// 				who: BOB,
// 				free: 200,
...
// 		for event in events() {
// 			match event {
// 				RuntimeEvent::Tokens(crate::Event::Locked { .. }) => assert!(false,
// "unexpected lock event"), 				RuntimeEvent::Tokens(crate::Event::Unlocked { .. })
// => assert!(false, "unexpected unlock event"), 				_ => continue,
// 			}
// 		}
