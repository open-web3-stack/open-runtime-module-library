...
fn transfer_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_last_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: ALICE, to: BOB, amount: 50}));
...
fn transfer_keep_alive_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_last_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: ALICE, to: BOB, amount: 98}));
...
fn transfer_all_keep_alive_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_has_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: ALICE, to: CHARLIE, amount: 98}));
			assert_eq!(Tokens::free_balance(DOT, &ALICE), 2);
			...
			System::assert_has_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: BOB, to: CHARLIE, amount: 50}));
		});
}
...
fn transfer_all_allow_death_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_last_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: ALICE, to: CHARLIE, amount: 100}));
			assert!(!Accounts::<Runtime>::contains_key(ALICE, DOT));
			assert_eq!(Tokens::free_balance(DOT, &ALICE), 0);
			...
			System::assert_last_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: BOB, to: CHARLIE, amount: 50}));
		});
}
...
fn force_transfer_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_last_event(Event::Tokens(crate::Event::Transfer{currency_id: DOT, from: ALICE, to: BOB, amount: 100}));
			assert!(!Accounts::<Runtime>::contains_key(ALICE, DOT));
			assert_eq!(Tokens::free_balance(DOT, &ALICE), 0);
...
fn set_balance_should_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_has_event(Event::Tokens(crate::Event::BalanceSet{currency_id: DOT, who: ALICE, free: 200, reserved: 100}));
			assert!(Accounts::<Runtime>::contains_key(ALICE, DOT));
			...
			System::assert_has_event(Event::Tokens(crate::Event::BalanceSet{currency_id: DOT, who: BOB, free: 0, reserved: 0}));
			assert!(!Accounts::<Runtime>::contains_key(BOB, DOT));
			...
			System::assert_has_event(Event::Tokens(crate::Event::BalanceSet{currency_id: DOT, who: CHARLIE, free: 0, reserved: 0}));
			assert!(!Accounts::<Runtime>::contains_key(CHARLIE, DOT));
			assert_eq!(Tokens::free_balance(DOT, &CHARLIE), 0);
			assert_eq!(Tokens::reserved_balance(DOT, &CHARLIE), 0);
			assert_eq!(Tokens::total_issuance(DOT), 300);
...
fn endowed_account_work() {
	ExtBuilder::default().build().execute_with(|| {
		...
		System::assert_last_event(Event::Tokens(crate::Event::Endowed{currency_id: DOT, who: ALICE, amount: 100}));
		assert_eq!(System::providers(&ALICE), 1);
		assert!(Accounts::<Runtime>::contains_key(ALICE, DOT));
	});
}
...
fn dust_removal_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(Tokens::free_balance(DOT, &DustReceiver::get()), 0);
			Tokens::set_free_balance(DOT, &ALICE, 1);
			System::assert_last_event(Event::Tokens(crate::Event::DustLost{currency_id: DOT, who: ALICE, amount: 1}));
			assert_eq!(System::providers(&ALICE), 0);
			assert!(!Accounts::<Runtime>::contains_key(ALICE, DOT));
			assert_eq!(Tokens::free_balance(DOT, &ALICE), 0);
			assert_eq!(Tokens::free_balance(DOT, &DustReceiver::get()), 1);
			...
			assert_eq!(Tokens::free_balance(DOT, &DAVE), 1);
			System::assert_last_event(Event::Tokens(crate::Event::Endowed{currency_id: DOT, who: DAVE, amount: 1}));
		});
}
...
fn multi_reservable_currency_reserve_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_ok!(Tokens::reserve(DOT, &ALICE, 50));
			System::assert_last_event(Event::Tokens(crate::Event::Reserved{currency_id: DOT, who: ALICE, amount: 50}));
			assert_eq!(Tokens::free_balance(DOT, &ALICE), 50);
			assert_eq!(Tokens::reserved_balance(DOT, &ALICE), 50);
			assert_eq!(Tokens::total_balance(DOT, &ALICE), 100);
			...
			assert!(System::events()
				.iter()
				.all(
					|record| !matches!(record.event, Event::Tokens(crate::Event::Endowed{currency_id: DOT, who: ALICE, amount: _}))
				)
			);
		});
}
...
fn multi_reservable_currency_unreserve_work() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			System::assert_last_event(Event::Tokens(crate::Event::Unreserved{currency_id: DOT, who: ALICE, amount: 0}));
			assert_ok!(Tokens::reserve(DOT, &ALICE, 30));
			System::assert_last_event(Event::Tokens(crate::Event::Reserved{currency_id: DOT, who: ALICE, amount: 30}));
			...
			System::assert_last_event(Event::Tokens(crate::Event::Unreserved{currency_id: DOT, who: ALICE, amount: 15}));
			...
			assert!(System::events()
				.iter()
				.all(|record| !matches!(record.event, Event::Tokens(crate::Event::Endowed{currency_id: DOT, who: ALICE, amount: _}))));
		});
}
