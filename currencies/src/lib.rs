...
pub mod module {
	...
	pub enum Event<T: Config> {
		...
		Transferred{currency_id: CurrencyIdOf<T>, from: T::AccountId, to: T::AccountId, amount: BalanceOf<T>},
		/// Update balance success.
		BalanceUpdated{currency_id: CurrencyIdOf<T>, who: T::AccountId, amount: AmountOf<T>},
		/// Deposit success.
		Deposited{currency_id: CurrencyIdOf<T>, who: T::AccountId, amount: BalanceOf<T>},
		/// Withdraw success.
		Withdrawn{currency_id: CurrencyIdOf<T>, who: T::AccountId, amount: BalanceOf<T>},
	}
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn transfer_native_currency(
			...
			Self::deposit_event(Event::Transferred{currency_id: T::GetNativeCurrencyId::get(), from, to, amount});
			Ok(())
		}
...
impl<T: Config> MultiCurrencyExtended<T::AccountId> for Pallet<T> {
	...
	fn update_balance(currency_id: Self::CurrencyId, who: &T::AccountId, by_amount: Self::Amount) -> DispatchResult {
		...
		Self::deposit_event(Event::BalanceUpdated{currency_id, who: who.clone(), amount: by_amount});
		Ok(())
	}
}
