...
pub trait NamedMultiReservableCurrency<AccountId>: MultiReservableCurrency<AccountId> {
	...
	fn slash_reserved_named(id: &Self::ReserveIdentifier, currency_id: Self::CurrencyId, who: &AccountId, value: Self::Balance) -> Self::Balance;
	...
	fn reserve_named(id: &Self::ReserveIdentifier, currency_id: Self::CurrencyId, who: &AccountId, value: Self::Balance) -> DispatchResult;
	...
	fn unreserve_named(id: &Self::ReserveIdentifier, currency_id: Self::CurrencyId, who: &AccountId, value: Self::Balance) -> Self::Balance;
